...
module.exports = {
  ...
  initDB: async function () {
    const database = client.db('codeDB');
    const codes = database.collection('codesCollection');
    const res = await codes.insertMany([{
      "title": "For loop",
      "description": "Loops are handy, if you want to run the same code over and over again, each time with a different value.",
      "example": "`for (let i = 0; i < Array.length; i++) {sum += Array[i]}`",
    ...
    },
    {
      ...
      "example": "`const salad = ['🍅', '🥦', '🍄', '🥦', '🥦', '🌽', '🥦', '🥕', '🥑'];const result = salad.filter(vegetable =>vegetable !== '🥦');//result = ['🍅', '🍄', '🌽', '🥕', '🥑']`",
    ...
    },
    {
      ...
      "example": "const ages = [3,10,18,20];ages.some(checkAdult);function checkAdult(age) {return age > 18; //(return true)",
    ...
    },
    {
      ...
      "example": "const ages = [32,33,16,40];ages.every(checkAge)function checkAge(age) {return age > 18;//(return false)",
    ...
    },
    {
      ...
      "example": "const salad = ['🍅','🍄','🥦','🥒','🌽','🥕','🥑'];salad.push('🥜');//(return ['🍅', '🍄', '🥦', '🥒', '🌽', '🥕', '🥑', '🥜'])`",
      "challenge": "`Add the number 50 to the end of the array: [5,32,30,13,1,14] `",
      "code": ""
    },
    {
      "title": "Pop method",
      ...
      "example": "`const salad = ['🍅','🍄','🥦','🥒','🌽','🥕','🥑'];salad.pop();//(return ['🍅', '🍄', '🥦', '🥒', '🌽', '🥕'])`",
